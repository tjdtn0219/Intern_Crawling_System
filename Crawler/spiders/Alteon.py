...
import re
from Crawler.spiders.Selenium_Spider import Selenium_Spider


class AlteonSpider(Selenium_Spider):
    name = 'alteon'
    settings = get_project_settings()
    url = settings['URLS']['ALTEON'] + "#page/APSoluteVision_4.30_RN%2FAPSoluteVision_4.30_RN.1.12.html%23"
